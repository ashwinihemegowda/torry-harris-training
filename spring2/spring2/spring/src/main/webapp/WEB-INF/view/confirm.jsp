...
<style>
body
{ background-color:#c3ffa1;
}
h3{ text-align:left;
 }
 table
 { font-family: arial, sans-serif; border-collapse: collapse; width: 50%; margin-right: auto;
 ...
 <div id="htmlContent">
  ...
  <th>Age</th>
   ...
   <td>${gender}</td>
    ...
    <p> <button id="generatePDF">Download Ticket</button> </p>
     </center>
...
{ 'width': 100, 'elementHandlers': specialElementHandlers }); doc.save('${pnr}.pdf'); });
 ...
 Thank you <a href="index.jsp" class="button">click here</a> to go to main menu
</html>